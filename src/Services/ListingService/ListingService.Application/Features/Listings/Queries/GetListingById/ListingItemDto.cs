...
public class ListingItemDto
{
    ...
    // public string SellerUsername { get; set; } // May need to call User service or have this denormalized
    ...
    public string Status { get; set; } = string.Empty; // From ListingStatus enum
